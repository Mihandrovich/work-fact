    ...
    <div class="content">
      <div class="container-fluid">
        <div class="callout callout-info">
            ...
            Внимание, НИКОМУ не сообщайте данные вашего аккаунта! Внимательно читайте описание заданий, используйте VPN, если об этом написано! По всем вопросам писать в группу вк - <a style="color:#ffffff;" href="https://vk.com/mi_prod">https://vk.com/mi_prod</a> 
        </div>
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
                  ...
                  <tbody>
                    <?
                      $top = 0;
                      $orders = mysqli_query($link, "SELECT * FROM `orders` WHERE `top`='1' AND `status`='0' LIMIT 20");
                ...
                ?>
                    <?
                      $limit = 20 - $top;
                      $orders = mysqli_query($link, "SELECT * FROM `orders` WHERE `top`='0' AND `status`='0' LIMIT $limit");
                        While($orders_data = mysqli_fetch_array($orders)){
                    ?>
                  <tr>
                    <td>
