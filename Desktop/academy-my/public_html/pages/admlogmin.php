...
<head>
  ...
  <title><?echo $server_data[sitename];?> - ПАНЕЛЬ</title>
...
<div class="lockscreen-wrapper">
  ...
  <div class="lockscreen-item">
    <div class="lockscreen-image">
      <img src="../dist/img/adrt.png" alt="User Image">
    </div>

    <form class="lockscreen-credentials" action="admin-check-pass.php" method="post">
